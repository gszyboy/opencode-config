---
description: 开始开发任务（Ultrawork模式 + 进度追踪）
agent: build
---

ulw

## ULTRAWORK MODE ENABLED! 🔥 + 任务进度追踪

**当前任务**：$ARGUMENTS

---

本命令已激活 Ultrawork 模式！同时遵循任务进度追踪流程。
...
### Ultrawork 执行策略
1. 并行调用 Explore 代理探索代码库
2. 并行调用 Librarian 代理查阅相关文档
3. 必要时调用 Oracle 代理进行架构评审
4. 使用 Category + Skills 系统委派任务
5. 强制完成验证（TDD 工作流）
